...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        welcome: "Welcome to Black Cat 2022, please provide your email address in order to be invited and receive the real location of the event.",
        internet_explorer_warning: "NOTE: I see you're using internet explorer, this sound bad for this website and your security.",
        invalid_command_message: "Please, enter a valid email address.",
        response_from_api: "",
        host: "hacker",
        user: "blackcat",
        is_root: false,
...
var main = (function () {
    ...
    var Terminal = function (prompt, cmdLine, output, sidenav, profilePic, user, host, root, outputTimer) {
        ...
        (typeof user === "string" && typeof host === "string") && (this.completePrompt = "Your email address: ");
    ...
    Terminal.prototype.handleCmd = function () {
        ...
        this.lock();
        if(validateEmail(cmdComponents[0]))
        {
    ...
    Terminal.prototype.apiResponse = function(cmdComponents,resp) {
        this.type(configs.getInstance().response_from_api+resp.replace(configs.getInstance().value_token, cmdComponents[0]), this.unlock.bind(this));
    }
